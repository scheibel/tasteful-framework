...
#include <tasteful-framework/MimeDatabase.h>
...
tastefulserver::ContentType MimeDatabase::contentTypeFor(const QString & suffix, const QString & defaultValue)
{
    return tastefulserver::ContentType::fromString(mimeTypeFor(suffix, defaultValue));
}

tastefulserver::ContentType MimeDatabase::contentTypeForFilename(const QString & filename, const QString & defaultValue)
{
