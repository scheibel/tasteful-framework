...
#include <tasteful-framework/StringConvertible.h>
...
class TASTEFUL_FRAMEWORK_API DomNode : public StringConvertible
{
public:
    DomNode();
...
class TASTEFUL_FRAMEWORK_API RawXml : public StringConvertible
{
public:
    RawXml(DomNode & node);
...
class TASTEFUL_FRAMEWORK_API InnerXml : public StringConvertible
{
public:
...
class TASTEFUL_FRAMEWORK_API DomAttribute : public StringConvertible
{
public:
    DomAttribute();
...
class TASTEFUL_FRAMEWORK_API DomAttributes : public StringConvertible
{
public:
...
class TASTEFUL_FRAMEWORK_API DomNodeList : public QList<DomNode>, public StringConvertible
{
public:
    DomNodeList();
...
class TASTEFUL_FRAMEWORK_API DomNodeProducer
{
public:
    virtual DomNode toDomNode() const = 0;
};

class TASTEFUL_FRAMEWORK_API QDomNodeCreator
{
public:
...
#include <tasteful-framework/DomNode.hpp>
