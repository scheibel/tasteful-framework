...
class TASTEFUL_FRAMEWORK_API NodeCreator
{
public:
    NodeCreator();
...
class TASTEFUL_FRAMEWORK_API NodeCreatorPlaceholder
{
public:
...
class TASTEFUL_FRAMEWORK_API DomHelper
{
public:
...
#include <tasteful-framework/DomHelper.hpp>
