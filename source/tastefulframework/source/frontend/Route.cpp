...
RequestedAction::RequestedAction(const tastefulserver::HttpMethod& method, const QString& path) : method(method), path(path) {
}
...
Route::Route(const tastefulserver::HttpMethod& method, const QString& urlPattern) : method(method), urlPattern(urlPattern), action(nullptr)
{
}
...
StaticRoute::StaticRoute(const tastefulserver::HttpMethod& method, const QString& urlPattern) : Route(method, urlPattern) {
}
...
DynamicRoute::DynamicRoute(const tastefulserver::HttpMethod& method, const QString& urlPattern) : Route(method, urlPattern)
{
...
WildcardRoute::WildcardRoute(const tastefulserver::HttpMethod& method, const QString& urlPattern) : Route(method, urlPattern) {
