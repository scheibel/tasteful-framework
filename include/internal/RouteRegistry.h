...
namespace internal {
	class RouteRegistry : public QObject {
		...
		public:
			...
			Route* obtain(const HttpMethod& method, const QString& urlPattern);
			static Route* getOrCreate(const HttpMethod& method, const QString& urlPattern);
			...
			static Key keyFor(const HttpMethod& method, const QString& urlPattern);
